...
import com.example.zyzeng.homeworkhit.config.IpConfg;
import com.example.zyzeng.homeworkhit.config.RequestConfig;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        imageButton = findViewById(R.id.back_home);
        ...
        sqLiteManager = new MyDB(getApplicationContext());//数据库
        //如果用户没有登陆,那么跳转到登陆页面
    ...
    private void checkLogin(final String email, final String password) {
        ...
        //发起登陆请求
        StringRequest strReq = new StringRequest(Request.Method.POST, IpConfg.URL_LOGIN_Test, new Response.Listener<String>() {
            @Override
        ...
        RequestConfig.getInstance().addToRequestQueue(strReq, tag_string_req);
    }
