package com.example.zyzeng.homeworkhit.config;
 ...
 */
public class RequestConfig extends Application {
    public static final String TAG = RequestConfig.class.getSimpleName();
    private RequestQueue myRequestQueue;
    private static RequestConfig mInstance;
